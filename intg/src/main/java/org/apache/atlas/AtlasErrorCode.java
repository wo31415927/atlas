...
public enum AtlasErrorCode {
     ...
     * 支持中文分类名称
     */
    TYPE_NAME_INVALID_FORMAT(400, "ATLAS-400-00-019", "{0}: invalid name for {1}.  Names must consist of a letter followed by a sequence of letter, number, 汉字, or '_' characters"),
