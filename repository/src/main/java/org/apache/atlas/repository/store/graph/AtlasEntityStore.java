...
public interface AtlasEntityStore {
     ...
     * @return AtlasEntity
     */
    AtlasEntityWithExtInfo getById(String guid, boolean isMinExtInfo, boolean ignoreRelationships, boolean includeClassificationType) throws AtlasBaseException;
